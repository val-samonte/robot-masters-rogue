...
- [ ] 2. Create instance structures for runtime state
...
- [ ] 3. Modify Character struct to use ID-based behaviors
...
- [ ] 4. Update GameState to include definition collections
...
- [ ] 5. Modify public API to accept definition collections
...
- [ ] 6. Update behavior execution system for ID-based lookups
...
- [ ] 7. Update spawn system to use definition-based references
...
- [ ] 8. Implement error handling for invalid ID references
...
- [ ] 9. Update serialization to include definition collections
...
- [ ] 10. Convert existing test utilities to definition-based format
...
- [ ] 11. Update behavior integration tests
...
- [ ] 12. Update cooldown system tests
...
- [ ] 14. Update entity and state tests
...
- [ ] 15. Update all remaining test files
